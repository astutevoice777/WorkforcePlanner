...
import { usePayrollIntegrated } from '@/hooks/usePayrollIntegrated';
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium">${(summary.totalGrossPay - summary.totalNetPay).toFixed(2)}</span>
                    </div>
                    <div className="flex items-center justify-between">
